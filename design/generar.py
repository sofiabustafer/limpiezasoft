...
SEQUENCES = [
    ...
    ], 'Si PostgreSQL rechaza la escritura, la sesión hace rollback y traduce el error a ErrorDatos; se conserva el formulario. En usuarios, validar() genera el hash antes de abrir la sesión. Para detalles y pagos se agregan las reglas de SQ03 y SQ04.'),
